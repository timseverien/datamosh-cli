...
module.exports = async (source, destination, options = {}) => {
...

    {
        ...
        try {
            ...
            console.log(`Unable to create dir "${pathIntermediateDirectory}" - this might take a couple of minutes`);
        }
    }
    ...
    console.log(`Destroying "${pathIntermediateSource}" - this might take a couple of minutes`);
    ...
    console.log(`Moving "${pathIntermediateDestination}" to "${pathDestination}" - this might take a couple of minutes`);
